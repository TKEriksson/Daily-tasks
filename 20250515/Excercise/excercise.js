...
/*
  This made me sidetrack to primise, API´s, fetch, and THEN await and async...
  First i need to understand Promise...
  ...
  x
  .resolve - om det lyckas.
  .reject - om det misslyckas.
  .finally - oavsett (efter).
...
*/
  ...
  //     if (v === true) { setTimeout(res("Resolved! :D", 1000)); }
    
  //     if (v === false) {  setTimeout(rej("reject for no real reason, just false input."), 1500); }
  ...
  //   // Noterat: i en arrowfunction, så är return automatiskt om det står på samma rad. (data) => json; (ej måsvingar, bara det som ska returneras)
  // test(false).then((ret) => { console.log(ret)}).catch((ret) => { console.log(ret)});
  ...
  // Okey, i get it.
  //https://www.youtube.com/watch?v=_Yz96nQ6S0I&list=PLaknUI4-UhkJDdcXIWZn0tvxTDjmUW096&index=21




  // Kollar 22 och 23 på Lindh - videos, så ska jag nog kunna lösa denna sen.

  //https://www.youtube.com/watch?v=bkIbBtkddxc&list=PLaknUI4-UhkJDdcXIWZn0tvxTDjmUW096&index=22
  //https://www.youtube.com/watch?v=bkIbBtkddxc&list=PLaknUI4-UhkJDdcXIWZn0tvxTDjmUW096&index=23
  
  /* testar lite
  https://jsonplaceholder.typicode.com/posts?_limit=1&_start=0
   */

  console.log("\n\n");
const tryFetch = fetch("https://jsonplaceholder.typicode.com/posts?_limit=5",{
  method: "GET", 
  headers: {
...
console.log(); // logs out "pending" in beginning bco delay. Its a promise.
